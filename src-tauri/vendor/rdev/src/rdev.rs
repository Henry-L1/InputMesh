...
pub struct Event {
    ...
    /// Raw relative pointer movement supplied by the operating system, when
    /// available.
    #[cfg_attr(feature = "serialize", serde(default))]
    pub relative_delta: Option<(i64, i64)>,
    /// True when this event was posted by rdev itself rather than originating
